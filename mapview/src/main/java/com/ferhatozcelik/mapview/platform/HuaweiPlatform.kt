...
import com.ferhatozcelik.mapview.interfaces.IHuaweiPlatform
...
class HuaweiPlatform(private val mapsView: com.ferhatozcelik.mapview.MapsView) : IHuaweiPlatform,
    OnMapReadyCallback {
